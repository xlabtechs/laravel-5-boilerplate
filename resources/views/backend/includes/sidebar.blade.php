<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ active_class(Active::checkUriPattern('admin/articles')) }}" href="{{ route('admin.article.index') }}"><i class="icon-list"></i> {{ __('menus.backend.sidebar.articles') }}</a>
            </li>
