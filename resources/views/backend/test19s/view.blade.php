<div class="row mt-4 mb-4">
    <div class="col">
        ...
        <div class="form-group row">
            {{ html()->label(__('validation.attributes.backend.test19s.id'))->class('col-md-2 form-control-label')->for('id') }}
            <div class="col-md-10">
                {{ $test19->id }}
            </div><!--col-->
        </div><!--form-group-->
        ...
        <div class="form-group row">
            {{ html()->label(__('validation.attributes.backend.test19s.zipcode'))->class('col-md-2 form-control-label')->for('zipcode') }}
            <div class="col-md-10">
                {{ $test19->zipcode }}
            </div><!--col-->
        </div><!--form-group-->
